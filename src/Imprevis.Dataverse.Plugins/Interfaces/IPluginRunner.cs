...
public interface IPluginRunner<in TRequest> where TRequest : OrganizationRequest
{
    /// <summary>
    /// This method is called by the plugin to execute the plugin logic.
    /// </summary>
...
public interface IPluginRunner<in TRequest, out TResponse> where TRequest : OrganizationRequest where TResponse : OrganizationResponse
{
    /// <summary>
    /// This method is called by the plugin to execute the plugin logic.
    /// </summary>
